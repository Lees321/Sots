				...
				<div class="row">
					<div class="col-lg-8">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<img src="${ctx }/static/img/cards_all.svg" alt="Cards" class="cards-payment">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-8">
											<img src="${ctx }/static/img/icon_ccv.gif" width="50" height="29" alt="ccv"><small>Last 3 digits</small>
										</div>
									</div>
								</div>
							</div>
						...
						<p>
							<a href="#0"><img src="${ctx }/static/img/paypal_bt.png" alt="Image"></a>
						</p>
						</div>
						<hr>
						<!--End step -->
