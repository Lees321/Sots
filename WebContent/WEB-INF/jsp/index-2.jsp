					...
					<ul class="slides">
						<li>
							...
							<div class="caption">
								...
								<small>$75 per person <strong id="weather" class="weather"></strong></small>
							</div>
						</li>
						<li>
							...
							<div class="caption">
								...
								<small>$75 per person <strong id="weather_2" class="weather"></strong></small>
							</div>
						</li>
						<li>
							...
							<div class="caption">
								...
								<small>$45 per person <strong id="weather_3" class="weather"></strong></small>
							</div>
						</li>
						<li>
							...
							<div class="caption">
								...
								<small>$85 per person <strong id="weather_4" class="weather"></strong></small>
							</div>
						</li>
						<li>
							...
							<div class="caption">
								...
								<small>$75 per person <strong id="weather_5" class="weather"></strong></small>
							</div>
						</li>
					</ul>
				</div>
