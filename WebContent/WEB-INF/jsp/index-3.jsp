...
<body>
	...
	<main>
		<section class="header-video">
			...
			<img src="${ctx }/static/img/video_fix.png" alt="" class="header-video--media" data-video-src="video/intro" data-teaser-source="video/intro" data-provider="" data-video-width="1920" data-video-height="960">
		</section>
		<!-- /header-video -->
	...
	<!-- SPECIFIC SCRIPTS -->
	<script src="${ctx }/static/js/video_header.js"></script>
	<script>
		HeaderVideo.init({
