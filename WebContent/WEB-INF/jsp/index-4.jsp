...
<head>
	...
	<!-- SPECIFIC CSS -->
    <link href="layerslider/${ctx }/static/css/layerslider.css" rel="stylesheet">
...
<body>
		...
		<div id="full-slider-wrapper">
			<div id="layerslider" style="width:100%;height:750px;">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="${ctx }/static/img/home_slider/slide_1.jpg" class="ls-bg" alt="Slide background">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;white-space: nowrap;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='hotels-grid-isotope.jsp'>Read more</a>
				</div>
				<!-- second slide -->
				<div class="ls-slide" data-ls="slidedelay:5000; transition2d:103;">
					<img src="${ctx }/static/img/home_slider/slide_2.jpg" class="ls-bg" alt="Slide background">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;white-space: nowrap;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='tours-grid-isotope.jsp'>Read more</a>
				</div>
				<!-- third slide -->
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
					<img src="${ctx }/static/img/home_slider/slide_3.jpg" class="ls-bg" alt="Slide background">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='tours-grid-sidebar.jsp'>Read more</a>
				</div>
			</div>
		</div>
		<!-- End layerslider -->
	...
	<!-- SPECIFIC SCRIPTS -->
    <script src="layerslider/${ctx }/static/js/greensock.js"></script>
    <script src="layerslider/${ctx }/static/js/layerslider.transitions.js"></script>
    <script src="layerslider/${ctx }/static/js/layerslider.kreaturamedia.jquery.js"></script>
    <script>
        'use strict';
