		...
		<div class="container margin_60_35">
			...
			<div class="grid">
				<ul class="magnific-gallery">
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_1.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_1.jpg" title="Photo title" data-effect="mfp-zoom-in">
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_2.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_2.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Your caption</p>
									</a>
								</div>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_3.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_3.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Your caption</p>
									</a>
								</div>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_4.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_1.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_5.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_1.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_6.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_6.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Your caption</p>
									</a>
								</div>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_7.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_7.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Your caption</p>
									</a>
								</div>
					...
					<li>
						<figure>
							<img src="${ctx }/static/img/gallery/large/pic_8.jpg" alt="">
							<figcaption>
								<div class="caption-content">
									<a href="${ctx }/static/img/gallery/large/pic_8.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Your caption</p>
									</a>
								</div>
