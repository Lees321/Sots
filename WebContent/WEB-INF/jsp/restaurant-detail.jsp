...
<body>
		...
		<section class="hero_in restaurants_detail">
			<div class="wrapper">
				...
				<span class="magnific-gallery">
					<a href="${ctx }/static/img/gallery/restaurant_list_1.jpg" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">View photos</a>
					<a href="${ctx }/static/img/gallery/restaurant_list_2.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
					<a href="${ctx }/static/img/gallery/restaurant_list_3.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
				</span>
			</div>
		</section>
		<!--/hero_in-->
				...
				<div class="row">
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail booking">
							...
							<a href="cart-1.jsp" class=" add_top_30 btn_1 full-width purchase">Book now</a>
	...
	<script src="${ctx }/static/js/map_single_restaurant.js"></script>
