				...
				<ul class="clearfix">
					...
					<li>
						<div class="layout_view">
							...
							<a href="restaurants-list-isotope.jsp"><i class="icon-th-list"></i></a>
						</div>
					</li>
					<li>
						...
						<div class="collapse show" id="collapseFilters">
							<div class="filter_type">
								...
								<ul>
									...
									<li>
										<label>
											<input type="checkbox" class="icheck">Restaurants <small>(45)</small>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" class="icheck">Bars <small>(30)</small>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" class="icheck">Coffe Bars <small>(25)</small>
										</label>
									</li>
								</ul>
							</div>
					...
					<div class="row">
						<div class="col-md-6 isotope-item popular">
							<div class="box_grid">
								<figure>
									...
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_1.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">King food</a></h3>
						...
						<div class="col-md-6 isotope-item latest">
							<div class="box_grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_2.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">Catrine</a></h3>
									<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
						...
						<div class="col-md-6 isotope-item popular">
							<div class="box_grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_3.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">Bella Napoli</a></h3>
									<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
						...
						<div class="col-md-6 isotope-item latest">
							<div class="box_grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_4.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">Slow Food</a></h3>
									<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
						...
						<div class="col-md-6 isotope-item popular">
							<div class="box_grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_5.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">Andrew Fish</a></h3>
									<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
						...
						<div class="col-md-6 isotope-item latest">
							<div class="box_grid">
								<figure>
									<a href="#0" class="wish_bt"></a>
									<a href="restaurant-detail.jsp"><img src="${ctx }/static/img/restaurant_6.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
									<small>Paris Centre</small>
								</figure>
								<div class="wrapper">
									<h3><a href="restaurant-detail.jsp">Da Alfredo</a></h3>
									<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
