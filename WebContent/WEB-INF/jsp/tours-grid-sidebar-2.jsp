...
<body>
				...
				<ul class="clearfix">
					...
					<li>
						<div class="layout_view">
							...
							<a href="tours-list-sidebar-2.jsp"><i class="icon-th-list"></i></a>
						</div>
					</li>
					<li>
						...
						<div class="row">
							...
							<div class="col-md-6 isotope-item latest">
								<div class="box_grid">
									<figure>
										<a href="#0" class="wish_bt"></a>
										<a href="tour-detail.jsp"><img src="${ctx }/static/img/tour_6.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
										<small>Museum</small>
									</figure>
									<div class="wrapper">
	...
	<script src="${ctx }/static/js/map_tours.js"></script>
