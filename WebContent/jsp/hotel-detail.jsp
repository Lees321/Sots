...
<body>
	...
	<main>
		<section class="hero_in hotels_detail">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>${proId.proName }<!-- Hotel detail page --></h1>
				</div>
				<span class="magnific-gallery">
					...
					<%-- <a href="${ctx }/static/img/gallery/hotel_list_1.jpg" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">View photos</a>
					<a href="${ctx }/static/img/gallery/hotel_list_2.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
					<a href="${ctx }/static/img/gallery/hotel_list_3.jpg" title="Photo title" data-effect="mfp-zoom-in"></a> --%>
				</span>
			</div>
		</section>
		<!--/hero_in-->
				...
				<div class="row">
					<div class="col-lg-8">
						<section id="description">
							...
							<hr>
							<c:forEach items="${hotelId.hotels }" var="pro">
								<c:choose>
									<c:when test="${pro.zid%2==0}"><div class="room_type first"></c:when>
									<c:otherwise><div class="room_type gray"></c:otherwise>
								</c:choose>
								<!-- <div class="room_type first"> -->
								<div class="row">
									<div class="col-md-4">
										<img src="${ctx }/static/img/gallery/hotel_list_1.jpg" class="img-fluid" alt="">
									</div>
									<div class="col-md-8">
										<h4>${pro.zhotelType }</h4><h7>${pro.zid }</h7>
										<p>${pro.xxx }</p>
										<p style="text-align:right;">${pro.zhotelPrice }/day</p>
									</div>
								</div>
								<!-- /row -->
							</div>
								...
								<div class="row">
									...
									<div class="col-md-8">
										...
										<ul class="hotel_facilities">
											<li><img src="${ctx }/static/img/hotel_facilites_icon_2.svg" alt="">Single Bed</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_4.svg" alt="">Free Wifi</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_5.svg" alt="">Shower</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_7.svg" alt="">Air Condition</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_8.svg" alt="">Hairdryer</li>
										</ul>
									</div>
								</div>
								<!-- /row -->
							...
							<%-- <div class="room_type gray">
								<div class="row">
									<div class="col-md-4">
										<img src="${ctx }/static/img/gallery/hotel_list_2.jpg" class="img-fluid" alt="">
									</div>
									<div class="col-md-8">
										<h4>Double Room</h4>
										<p>Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam vulputate pertinacia eum at.</p>
										<ul class="hotel_facilities">
											<li><img src="${ctx }/static/img/hotel_facilites_icon_3.svg" alt="">Double Bed</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_4.svg" alt="">Free Wifi</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_6.svg" alt="">Bathtub</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_7.svg" alt="">Air Condition</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_8.svg" alt="">Hairdryer</li>
										</ul>
									</div>
							...
							<%-- <div class="room_type last">
								<div class="row">
									<div class="col-md-4">
										<img src="${ctx }/static/img/gallery/hotel_list_3.jpg" class="img-fluid" alt="">
									</div>
									<div class="col-md-8">
										<h4>Suite Room</h4>
										<p>Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam vulputate pertinacia eum at.</p>
										<ul class="hotel_facilities">
											<li><img src="${ctx }/static/img/hotel_facilites_icon_3.svg" alt="">King size Bed</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_4.svg" alt="">Free Wifi</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_6.svg" alt="">Bathtub</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_7.svg" alt="">Air Condition</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_9.svg" alt="">Swimming pool</li>
											<li><img src="${ctx }/static/img/hotel_facilites_icon_3.svg" alt="">Hairdryer</li>
										</ul>
									</div>
								</div>
								<!-- /row -->
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail booking">
							...
							<div class="price">
								<span>￥${proId.proValuation }<!-- 45$ --> <small>person</small></span>
	...
	<script src="${ctx }/static/js/map_single_hotel.js"></script>
