...
<body id="login_bg">
	...
	<div id="login">
		<aside>
			<figure>
				<a href="${ctx }/inlogin"><img src="${ctx }/static/img/logo_sticky.png" width="155" height="36" data-retina="true" alt="" class="logo_sticky"></a>
			</figure>
			  <form action="login" method="post">
				...
				<div class="text-center add_top_10">Sots 新成员? <strong><a href="register.jsp">注册账户!</a></strong></div>
			</form>
