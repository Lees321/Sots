				...
				<ul class="clearfix">
					<li>
						<div class="switch-field">
							...
							<label for="all"><a href="${ctx }/getProduct?op=1&yid=${yid}">All</a></label>
							<input type="radio" id="popular" name="listing_filter" value="popular" data-filter=".popular">
							<label for="popular"><a href="${ctx }/getProduct?op=1&yid=${yid}&proType=Popular">Popular</a></label>
							<input type="radio" id="latest" name="listing_filter" value="latest" data-filter=".latest">
							<label for="latest"><a href="${ctx }/getProduct?op=1&yid=${yid}&proType=Latest">Latest</a></label>
						</div>
					</li>
					<li>
						<div class="layout_view">
							<a href="${ctx }/getProduct?op=0&yid=${yid}"><i class="icon-th"></i></a>
		...
		<div class="container margin_60_35">
			...
			<!-- /custom-search-input-2 -->
	           ...
	           <ul class="pagination modal-1">
				  	<li>
		                <a href="${ctx }/getProduct?op=1&yid=${yid}&currpage=${pageInfo.pageNum-1}" class="prev">
		                   &laquo;
		                </a>
					</li>
		            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
		                ...
		                <c:if test="${page_Num != pageInfo.pageNum }">
		                    <li>
		                    	<a href="${ctx }/getProduct?op=1&yid=${yid}&currpage=${ page_Num}">${ page_Num}</a>
		                    </li>
		                </c:if>
		            </c:forEach>
		            <li>
		                <a href="${ctx }/getProduct?op=1&yid=${yid}&currpage=${pageInfo.pageNum+1}" class="next">
		                	&raquo;
		                </a>
		            </li>
				</ul>
